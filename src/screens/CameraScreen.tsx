  ...
  const handleSubmitProduct = async () => {
    ...
    try {
      const newProduct = await ProductService.addProduct({
        ...
        description: productForm.description || 'Produto adicionado via câmera',
        price,
      ...
      <View style={styles.permissionContainer}>
        <Card style={styles.permissionCard}>
          <Card.Content>
            ...
            <Paragraph>
              Para usar a câmera e adicionar produtos, precisamos da sua permissão para acessar a câmera.
            </Paragraph>
            <Button 
              mode="contained" 
